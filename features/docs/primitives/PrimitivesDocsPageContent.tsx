			...
			<DocsSectionPanel>
				<SectionHeader>
					<div className="max-w-3xl space-y-3">
						<Badge tone="brand">{t("docs.primitivesOverview.hero.badge")}</Badge>
						<SectionTitle>{t("docs.primitivesOverview.hero.title")}</SectionTitle>
						<SectionDescription>
				...
				<SectionContent className="grid gap-4 md:grid-cols-3">
					{summaryCardKeys.map(key => (
						...
						>
							<CardHeader>
								<CardTitle>{t(`docs.primitivesOverview.summary.${key}.title`)}</CardTitle>
								<CardDescription>
			...
			<DocsSectionPanel>
				<SectionHeader>
					<div className="space-y-3">
						<Badge tone="info">{t("docs.primitivesOverview.categories.badge")}</Badge>
						<SectionTitle>{t("docs.primitivesOverview.categories.title")}</SectionTitle>
						<SectionDescription>
						...
						>
							<CardHeader className="space-y-3">
								<div className="flex flex-wrap items-center justify-between gap-3">
									<CardTitle>{t(`docs.primitivesOverview.areas.${key}.title`)}</CardTitle>
									<Badge tone="neutral">
							...
							<CardContent className="pt-0">
								<DocsTextLink href={t(`docs.primitivesOverview.areas.${key}.href`)}>
